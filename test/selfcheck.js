...
async function run() {
  ...
  check(`Es sind genau 1092 Rueckbauten`, gpList.length === 1092, `${gpList.length}`);
...
// ueber beide Wege -- sonst waeren W2, W5 und W6 unerreichbar geworden.
  ...
  group('Die Kommentare je Datei — 0.34.1');
  {
    ...
    const COMMENT_TOTAL = { comment: 16390, code: 65729 };
