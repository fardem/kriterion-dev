...
p('beschlossen, bevor der erste Name fällt, und wer einen Namen findet, den');
p('sie nicht kennt, trägt ihn hier nach — nicht nebenbei im Code.');
p();
...
p('> *Ein Papier, das man neben der Liste pflegen muss, läuft ihr davon.*');
p();
p('**Die Regel, nach der hier benannt wird, hat einen Namen: gesunder');
p('Menschenverstand.** Ein Name muss SINNVOLL sein; unter');
