...
**13 Rückbauten gefahren, 4 Nebenspuren, Versatz 3500 je Spur — 13 von 13 rot,
0 STUMM.** *Gefahren gegen `f88479a`, jede in einer eigenen Kopie aus
...
| 646 | Die feste Ecke wandert wieder mit der Rastung | **erster Lauf:** „Die gegenueberliegende Kante bleibt dabei liegen", „Und der Mittelpunkt wandert auf ihr nicht", „Jeder Suchtext …" — **rot allein an den KANTEN, und das ist der Fund** (siehe unten); **nachgefahren gegen `e58b910`:** NACHGEFAHREN_646 |
