...
| **0.31.3** | **… türkisch — „Türkisch sitzt“** | **Auftrag `Doku/Auftrag_0.31.3.md`, geschrieben am 13.9.2026: sieben Leitplanken, elf Fragen, zehn Bauabschnitte, dreizehn Zusagen.** *`tr.json` ebenso — und es ist die schwerste der drei Sprachen: Türkisch ist agglutinierend und SOV, ein Satz, der dem deutschen Wort für Wort folgt, ist dort keine Übersetzung.* **Sie war der Grund für 0.31.1:** *an ihr ist das Zersägen schon einmal zerbrochen — „Bağlantın bundan değil etkilendi“ war keine Verneinung, sondern Kauderwelsch. Das kann jetzt nicht mehr passieren: ein Schlüssel trägt einen ganzen Satz (Regel S12).* *Gemessen liegen dort: **67 Werte mit deutschen Anführungszeichen**, **26 Blacklist-Treffer in 23 Schlüsseln** (der Wächter muss Wortstämme lesen — „hap“ steht als „haptan“), **44 Werte über 1,15×**, **sechs** mit mehr Sätzen, **vier** mit dem holprigen „Şu:“, **fünf** Vokabelmehrzahlen, die ihre Einzahl wiederholen, und **eine** HTML-Entität.* **Und eine Gegenleitplanke, die die Vorlage nicht sah:** *die Mehrzahl nach einer Zahl bleibt im Türkischen Einzahl — „3 dosya“; 28 gleiche Mehrzahlpaare sind deshalb korrekt und kein Fehler.* **Eine Vorlage von Google Gemini liegt daneben** *(`Doku/I18N_GENERATE_TR.md`)* | nein | — |
