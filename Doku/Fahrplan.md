...
| **0.31.0** | **Die Sprachdateien werden gegengelesen — deutsch** | `de.json`: elf Code-Lecks raus (aus allen drei), rund sechzig Texte geschärft, 34 Anführungszeichen berichtigt. *Auftrag 0.31.0 liegt* | nein | — |
