...
| ~~**0.31.2**~~ | ~~… englisch — „Englisch sitzt“~~ | **GEBAUT am 13. September 2026** — Änderungsprotokoll 0.31.2. *Der Durchgang durch alle 1197 englischen Schlüssel, jeder gegen seinen deutschen Satz: **158** englische Werte sind neu formuliert, 651 Zeichen weniger; kein deutscher und kein türkischer Wert ist angefasst. **PATCH**, kein Schemaanteil.* **Die beiden deutschen Prüfsummen der Gleichlautprobe sind Zeichen für Zeichen dieselben** — *das ist Leitplanke L1, und sie ist nachgerechnet und nicht behauptet.* *Die Verbotsliste der Vorlage ist ein Wächter im Prüfstand geworden (dreizehn Muster), dazu Länge, Satzzahl, Plätze, Entitäten und en-GB: zehn Zusagen, zehn Gegenproben.* **Der englische Stand liegt als Vergleichsdatei daneben** *(`tools/englisch-0312.json`)* | nein | — |
