...
| **0.31.1** | **Deutsch sitzt** | **Der Durchgang durch alle 1254 deutschen Schlüssel, 13.9.2026.** **211 Bruchstücke** in 130 Zeilen werden zu ganzen Sätzen; dazu ein Schlüssel, der Programmablauf führt (`entry.reportKind`), vier Stellen Stolperstein 47 und die vierzehn Vokabelbeschriftungen auf EINE Regel. *Der Wortlaut ändert sich nicht — nur seine Ablage.* **Keine offene Frage mehr: „Note" ist am 13.9.2026 nach 0.32.0 gegangen** | nein | — |
