...
| **0.31.2** | **… englisch — „Englisch sitzt“** | **Auftrag `Doku/Auftrag_0.31.2.md`, geschrieben am 13.9.2026: sechs Leitplanken, neun Fragen, sieben Bauabschnitte, zehn Zusagen.** `en.json` übersetzt die ABSICHT der deutschen Sätze, nicht ihre Wörter. *Heute steht dort „files that leaves the house“.* **0.31.1 hat es leichter gemacht: zu übersetzen sind jetzt ganze Sätze statt Hälften, und wo die Hervorhebung sitzt, entscheidet die Sprache selbst.** *Gemessen liegen dort: **36 Blacklist-Treffer in 33 Schlüsseln**, **sieben** Werte, die länger sind als ihr deutscher, **sechs**, die mehr Sätze tragen, und **eine** HTML-Entität.* **Eine Vorlage von Google Gemini liegt daneben** *(`Doku/I18N_GENERATE_EN.md`)* — *einundzwanzig Zitate, alle richtig; der Betreiber am 13.9.2026: „gemini ist nicht unser master. du kannst das auch genauso gut.“* | nein | — |
