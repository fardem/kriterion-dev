...
1. **Nur die Sicherung ist eine vollständige Kopie.**
...
| Die Karte „Sicherung" | `card.backupWhatHint` sagt „auch mit dem, was der Export nicht enthält" — was das ist, steht nirgends |
