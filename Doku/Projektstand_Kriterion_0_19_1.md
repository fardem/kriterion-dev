...
>
> * **0.19.2 steht vor jeder Runde mit einem Bestandslauf.** 0.19.3 und 0.21.0
>   fahren beide über alle Bilder; ohne sie hielte jede einzelne davon die
>   Installation wieder für Stunden an.
> * **0.19.3 bleibt trotzdem früh.** Eine unscharfe Kachel ist jeden Tag zu
>   sehen, die wählbare Ablage ist eine Bequemlichkeit. Nach 0.19.2 kostet ihr
>   Lauf niemanden mehr etwas.
> * **Die Ableitungen auf WebP fahren in 0.21.0 mit und nicht in 0.19.3.** Dort
...
>   nach 0.19.3: sie ist ein Fehler und hängt an keinem Verfahren.*
