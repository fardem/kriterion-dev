...
| **0.17.2** *PATCH* — **BEAUFTRAGT am 31. August 2026** | **Nichts aus diesem Blatt.** Fünf Befunde aus dem Rundlauf mit 0.17.1, zwei davon Nacharbeit an ihr selbst: der Name in der Anmeldezeile wird abgeschnitten, **die Listen brauchen einen Deckel bei zwölf Zeilen** (die Tagliste zog die Seite auf), der Mailversand ordnet sich zu Ende, die Klammer bei einer einzigen Stimme fällt weg — **und die Glocke meldet die eigenen Beiträge wieder nicht.** *Die zweite Wende an derselben Entscheidung: 0.16.0 schloss sie aus, 0.17.0 nahm das zurück, 0.17.2 stellt 0.16.0 wieder her.* **Der Auftrag liegt als `Doku/Auftrag_0.17.2.md` im Repo, die Kurzfassung im Projektstand, Abschnitt 10a.** |
