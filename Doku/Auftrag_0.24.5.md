...
| **F6** | **Bekommt die Karte „Kategorien" dieselbe Dreiteilung wie „Vokabular"?** *(eingetragen · wirksam · Vorgabe)* | **Nein, nicht in dieser Runde.** *Die Liste ist eine Liste und kein Formular mit vierzehn Feldern; drei Tafeln nebeneinander wären hier Aufwand ohne Leser. **Ein Vermerk je Zeile genügt** (F4)* |
| **F7** | **Wie viele Zellen hält der Prüfstand?** | **Alle achtzehn**, als Tafel und nicht als Stichprobe — *drei Lesersprachen × drei Pillen × zwei Karten, jede Zelle mit ihrem Sollwert daneben. Der Befund ist als Tafel gemeldet worden; er wird als Tafel nachgestellt.* **Dazu neun weitere an der Kachel „Vokabular" als GEGENSTÜCK** — *sie ist heute richtig, und eine Reparatur nebenan darf sie nicht mitnehmen. Eine Vergleichsgruppe, die vorher grün ist und grün bleibt, ist der billigste Schutz, den diese Runde haben kann* |
| **F8** | **Wird der Augenschein noch einmal gefahren?** | **Ja, aber klein** — die zwei Karten in drei Sprachen, sechs Bilder. *Der Fehler ist am Bildschirm gefunden worden und nicht im Prüfstand; er gehört auch am Bildschirm abgenommen* |
